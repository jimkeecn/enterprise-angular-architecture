...
/* FAKE DATA END */
@Component({
  selector: "app-investor-trust",
  templateUrl: "./investor-trust.component.html",
  styleUrls: ["./investor-trust.component.scss"]
})
export class InvestorTrustComponent implements OnInit {
